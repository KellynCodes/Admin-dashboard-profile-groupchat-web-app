...
<body>
  ...
  <header id="header" class="header fixed-top" data-scrollto-offset="0">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center scrollto me-auto me-lg-0">
        ...
        <h1>Enugu Tech Hub<span>.</span></h1>
      </a>
      ...
      <nav id="navbar" class="navbar ">
        <ul>
          ...
          <a class="btn-getstarted scrollto" href="register.php">Get Started</a>
        </ul>
  ...
  <section id="hero-fullscreen" class="hero-fullscreen d-flex align-items-center">
    <div class="container d-flex flex-column align-items-center position-relative" data-aos="zoom-out">
      <h2>Welcome to <span>Enugu Tech Hub</span></h2>
      <p>Center for innovation acquisition center. We train youths with life changing computer skills</p>
      <div class="d-flex">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Web Design</a></h4>
              <p>we train youths on how to design standard and reponsive websites</p>
            </div>
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <p>The  youths are also trained to develope functional, Dynamic and interactive website.</p>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="400">
            <div class="service-item position-relative">
              ...
              <p>Professional and good looking designs is what we offer for  the youths</p>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="600">
            <div class="service-item position-relative">
              ...
              <p>We also offer web apps development for smartphones</p>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="service-item">
              ...
              <div class="details position-relative">
                ...
                <p>A field where incoperate our daily business and bring it to the internet for wider range of services.</p>
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
            <div class="service-item">
              ...
              <div class="details position-relative">
                ...
                <p>A work involved in developing a website for the internet or intranet.</p><br>Our government have made it possible for enthusiasts in digital skills to acquire kowledge without paying a dime. 
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="400">
            <div class="service-item">
              ...
              <div class="details position-relative">
                ...
                <p> The is skills is very useful and life changing. We offer exclusive graphics design training.</p>
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="500">
            <div class="service-item">
              ...
              <div class="details position-relative">
                ...
                <p>In the world today, apps are needed to run many online and offline tasks with smartphone and computers. In Enugu-Tech-Hub we train youths with this digital skills also.</p>
